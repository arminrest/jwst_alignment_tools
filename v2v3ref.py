...
class v2v3refclass(pdastroclass):
    ...
    def get_v2v3info(self,aperture,filtername=None,progID=None):
        # get all entries for aperture
        ixs = self.ix_equal(self.param2col['apername'],aperture)
...
if __name__ == '__main__':
    ...
    (V2Ref,V3Ref,V3IdlYAngle,ix)=v2v3ref.get_v2v3info(args.aperture,filtername=args.filter,progID=args.progID)
    print(f'{args.aperture} filter={args.filter} progID={args.progID}: (V2Ref,V3Ref,V3IdlYAngle)=({V2Ref},{V3Ref},{V3IdlYAngle})')